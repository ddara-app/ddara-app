...
final cyclePhotoGalleryViewModelProvider = NotifierProvider.autoDispose
    .family<CyclePhotoGalleryViewModel, CyclePhotoGalleryState, int>(
      CyclePhotoGalleryViewModel.new,
    );

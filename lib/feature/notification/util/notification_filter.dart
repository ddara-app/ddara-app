...
enum NotificationFilter {
  ...
  String label(AppLocalizations l10n) => switch (this) {
    ...
    NotificationFilter.comment => l10n.notificationFilterComment,
  };

  /// [item] 이 이 기준에 걸리는지.
  ///
  /// 댓글은 [NotificationType.comment] 하나뿐이라, 나머지를 모두 일반 알림으로
  ...
  bool matches(NotificationItem item) => switch (this) {
    ...
    NotificationFilter.comment => item.type == NotificationType.comment,
  };
}

...
@override
String toString() {
  return 'Profile(id: $id, name: $name, profileImageUrl: $profileImageUrl, provider: $provider, createdAt: $createdAt)';
}
...
class _Profile implements Profile {
  const _Profile({required this.id, required this.name, required this.profileImageUrl, required this.provider, required this.createdAt});

...
mixin _$NotificationItem {
 ...
 int get id; NotificationType get type; NotificationPayload get payload;// 아직 읽지 않은 경우 null.
...
@useResult
$Res call({
 int id, NotificationType type, NotificationPayload payload, DateTime? readAt, DateTime createdAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  NotificationType type,  NotificationPayload payload,  DateTime? readAt,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationItem() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  NotificationType type,  NotificationPayload payload,  DateTime? readAt,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _NotificationItem():
return $default(_that.id,_that.type,_that.payload,_that.readAt,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  NotificationType type,  NotificationPayload payload,  DateTime? readAt,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _NotificationItem() when $default != null:
return $default(_that.id,_that.type,_that.payload,_that.readAt,_that.createdAt);case _:
  return null;
...
class _NotificationItem extends NotificationItem {
  const _NotificationItem({required this.id, required this.type, required this.payload, required this.readAt, required this.createdAt}): super._();

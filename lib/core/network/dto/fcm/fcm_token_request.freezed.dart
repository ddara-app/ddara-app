...
// FCM 이 발급한 디바이스 등록 토큰.
 String get token;// 발급 플랫폼. (예: "ios" / "android")
 String get platform;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FcmTokenRequest&&(identical(other.token, token) || other.token == token)&&(identical(other.platform, platform) || other.platform == platform));
}
...
class _FcmTokenRequest implements FcmTokenRequest {
  const _FcmTokenRequest({required this.token, required this.platform});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FcmTokenRequest&&(identical(other.token, token) || other.token == token)&&(identical(other.platform, platform) || other.platform == platform));
}

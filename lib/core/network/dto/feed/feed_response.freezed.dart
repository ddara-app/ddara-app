...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,shotId,type,imageUrl,imageUnderReview,userId,nickname,groupId,groupName,cycleId,topic,locked,uploadedAt);

@override
String toString() {
  return 'FeedItemResponse(shotId: $shotId, type: $type, imageUrl: $imageUrl, imageUnderReview: $imageUnderReview, userId: $userId, nickname: $nickname, groupId: $groupId, groupName: $groupName, cycleId: $cycleId, topic: $topic, locked: $locked, uploadedAt: $uploadedAt)';
}
...
@useResult
$Res call({
 int shotId, String type, String? imageUrl, bool imageUnderReview, int userId, String nickname, int groupId, String groupName, int cycleId, String topic, bool locked, DateTime uploadedAt
});
...
/// Create a copy of FeedItemResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? shotId = null,Object? type = null,Object? imageUrl = freezed,Object? imageUnderReview = null,Object? userId = null,Object? nickname = null,Object? groupId = null,Object? groupName = null,Object? cycleId = null,Object? topic = null,Object? locked = null,Object? uploadedAt = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int shotId,  String type,  String? imageUrl,  bool imageUnderReview,  int userId,  String nickname,  int groupId,  String groupName,  int cycleId,  String topic,  bool locked,  DateTime uploadedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FeedItemResponse() when $default != null:
return $default(_that.shotId,_that.type,_that.imageUrl,_that.imageUnderReview,_that.userId,_that.nickname,_that.groupId,_that.groupName,_that.cycleId,_that.topic,_that.locked,_that.uploadedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int shotId,  String type,  String? imageUrl,  bool imageUnderReview,  int userId,  String nickname,  int groupId,  String groupName,  int cycleId,  String topic,  bool locked,  DateTime uploadedAt)  $default,) {final _that = this;
switch (_that) {
case _FeedItemResponse():
return $default(_that.shotId,_that.type,_that.imageUrl,_that.imageUnderReview,_that.userId,_that.nickname,_that.groupId,_that.groupName,_that.cycleId,_that.topic,_that.locked,_that.uploadedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int shotId,  String type,  String? imageUrl,  bool imageUnderReview,  int userId,  String nickname,  int groupId,  String groupName,  int cycleId,  String topic,  bool locked,  DateTime uploadedAt)?  $default,) {final _that = this;
switch (_that) {
case _FeedItemResponse() when $default != null:
return $default(_that.shotId,_that.type,_that.imageUrl,_that.imageUnderReview,_that.userId,_that.nickname,_that.groupId,_that.groupName,_that.cycleId,_that.topic,_that.locked,_that.uploadedAt);case _:
  return null;
...
class _FeedItemResponse implements FeedItemResponse {
  const _FeedItemResponse({required this.shotId, required this.type, required this.imageUrl, this.imageUnderReview = false, required this.userId, required this.nickname, required this.groupId, required this.groupName, required this.cycleId, required this.topic, this.locked = false, required this.uploadedAt});
...
/// Create a copy of FeedItemResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? shotId = null,Object? type = null,Object? imageUrl = freezed,Object? imageUnderReview = null,Object? userId = null,Object? nickname = null,Object? groupId = null,Object? groupName = null,Object? cycleId = null,Object? topic = null,Object? locked = null,Object? uploadedAt = null,}) {

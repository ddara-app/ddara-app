...
@override
String toString() {
  return 'CommentResponse(commentId: $commentId, userId: $userId, nickname: $nickname, profileImageUrl: $profileImageUrl, content: $content, createdAt: $createdAt)';
}
...
class _CommentResponse implements CommentResponse {
  const _CommentResponse({required this.commentId, required this.userId, required this.nickname, required this.profileImageUrl, required this.content, required this.createdAt});

...
mixin _$GroupCycleResponse {
 ...
 bool get starterImageUnderReview; String get status; DateTime get startedAt; DateTime get deadlineAt;// 이번 사이클에 사진을 올린 멤버 userId 목록. (서버 미제공 시 빈 목록)
...
@override
String toString() {
  return 'GroupCycleResponse(cycleId: $cycleId, cycleNumber: $cycleNumber, topic: $topic, starterUserId: $starterUserId, starterNickname: $starterNickname, starterImageUrl: $starterImageUrl, starterImageUnderReview: $starterImageUnderReview, status: $status, startedAt: $startedAt, deadlineAt: $deadlineAt, uploadedUserIds: $uploadedUserIds)';
}
...
class _GroupCycleResponse implements GroupCycleResponse {
  const _GroupCycleResponse({required this.cycleId, required this.cycleNumber, required this.topic, required this.starterUserId, required this.starterNickname, required this.starterImageUrl, required this.starterImageUnderReview, required this.status, required this.startedAt, required this.deadlineAt, final  List<int> uploadedUserIds = const <int>[]}): _uploadedUserIds = uploadedUserIds;

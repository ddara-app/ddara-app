...
mixin _$GroupResponse {
 ...
 String? get thumbnailUrl;// 썸네일을 올린 사용자의 userId. 썸네일이 없으면 null.
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,groupId,name,ownerNickname,memberCount,thumbnailUrl,thumbnailUserId,currentCycle,createdAt);

@override
String toString() {
  return 'GroupResponse(groupId: $groupId, name: $name, ownerNickname: $ownerNickname, memberCount: $memberCount, thumbnailUrl: $thumbnailUrl, thumbnailUserId: $thumbnailUserId, currentCycle: $currentCycle, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 int groupId, String name, String ownerNickname, int memberCount, String? thumbnailUrl, int? thumbnailUserId, CurrentCycleResponse? currentCycle, DateTime createdAt
});
...
/// Create a copy of GroupResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? groupId = null,Object? name = null,Object? ownerNickname = null,Object? memberCount = null,Object? thumbnailUrl = freezed,Object? thumbnailUserId = freezed,Object? currentCycle = freezed,Object? createdAt = null,}) {
  return _then(_self.copyWith(
...
as String?,thumbnailUserId: freezed == thumbnailUserId ? _self.thumbnailUserId : thumbnailUserId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int groupId,  String name,  String ownerNickname,  int memberCount,  String? thumbnailUrl,  int? thumbnailUserId,  CurrentCycleResponse? currentCycle,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GroupResponse() when $default != null:
return $default(_that.groupId,_that.name,_that.ownerNickname,_that.memberCount,_that.thumbnailUrl,_that.thumbnailUserId,_that.currentCycle,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int groupId,  String name,  String ownerNickname,  int memberCount,  String? thumbnailUrl,  int? thumbnailUserId,  CurrentCycleResponse? currentCycle,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _GroupResponse():
return $default(_that.groupId,_that.name,_that.ownerNickname,_that.memberCount,_that.thumbnailUrl,_that.thumbnailUserId,_that.currentCycle,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int groupId,  String name,  String ownerNickname,  int memberCount,  String? thumbnailUrl,  int? thumbnailUserId,  CurrentCycleResponse? currentCycle,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _GroupResponse() when $default != null:
return $default(_that.groupId,_that.name,_that.ownerNickname,_that.memberCount,_that.thumbnailUrl,_that.thumbnailUserId,_that.currentCycle,_that.createdAt);case _:
  return null;
...
class _GroupResponse implements GroupResponse {
  const _GroupResponse({required this.groupId, required this.name, required this.ownerNickname, required this.memberCount, required this.thumbnailUrl, required this.thumbnailUserId, required this.currentCycle, required this.createdAt});
...
/// Create a copy of GroupResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? groupId = null,Object? name = null,Object? ownerNickname = null,Object? memberCount = null,Object? thumbnailUrl = freezed,Object? thumbnailUserId = freezed,Object? currentCycle = freezed,Object? createdAt = null,}) {

...
mixin _$CycleGalleryCycle {
 ...
 bool get starterImageUnderReview;// 스타터 사진에 읽지 않은 댓글이 있는지 여부. (댓글 버튼 강조 표시에 사용)
 bool get hasUnreadComments; String get status; DateTime get deadlineAt;
...
@useResult
$Res call({
 int cycleId, int cycleNumber, String topic, int starterUserId, String starterNickname, int starterShotId, String? starterImageUrl, bool starterImageUnderReview, bool hasUnreadComments, String status, DateTime deadlineAt
});
...
/// Create a copy of CycleGalleryCycle
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? cycleId = null,Object? cycleNumber = null,Object? topic = null,Object? starterUserId = null,Object? starterNickname = null,Object? starterShotId = null,Object? starterImageUrl = freezed,Object? starterImageUnderReview = null,Object? hasUnreadComments = null,Object? status = null,Object? deadlineAt = null,}) {
  return _then(_self.copyWith(
...
as bool,hasUnreadComments: null == hasUnreadComments ? _self.hasUnreadComments : hasUnreadComments // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int cycleId,  int cycleNumber,  String topic,  int starterUserId,  String starterNickname,  int starterShotId,  String? starterImageUrl,  bool starterImageUnderReview,  bool hasUnreadComments,  String status,  DateTime deadlineAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CycleGalleryCycle() when $default != null:
return $default(_that.cycleId,_that.cycleNumber,_that.topic,_that.starterUserId,_that.starterNickname,_that.starterShotId,_that.starterImageUrl,_that.starterImageUnderReview,_that.hasUnreadComments,_that.status,_that.deadlineAt);case _:
  return orElse();
...
class _CycleGalleryCycle implements CycleGalleryCycle {
  const _CycleGalleryCycle({required this.cycleId, required this.cycleNumber, required this.topic, required this.starterUserId, required this.starterNickname, required this.starterShotId, required this.starterImageUrl, required this.starterImageUnderReview, required this.hasUnreadComments, required this.status, required this.deadlineAt});
...
@override final  bool hasUnreadComments;
...
mixin _$CycleGalleryMember {
 ...
 DateTime? get uploadedAt;// 이 멤버의 사진에 읽지 않은 댓글이 있는지 여부. (댓글 버튼 강조 표시에 사용)
 bool get hasUnreadComments;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CycleGalleryMember&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.shotId, shotId) || other.shotId == shotId)&&(identical(other.nickname, nickname) || other.nickname == nickname)&&(identical(other.profileImageUrl, profileImageUrl) || other.profileImageUrl == profileImageUrl)&&(identical(other.isStarter, isStarter) || other.isStarter == isStarter)&&(identical(other.status, status) || other.status == status)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&(identical(other.uploadedAt, uploadedAt) || other.uploadedAt == uploadedAt)&&(identical(other.hasUnreadComments, hasUnreadComments) || other.hasUnreadComments == hasUnreadComments));
}


@override
int get hashCode => Object.hash(runtimeType,userId,shotId,nickname,profileImageUrl,isStarter,status,imageUrl,uploadedAt,hasUnreadComments);

@override
String toString() {
  return 'CycleGalleryMember(userId: $userId, shotId: $shotId, nickname: $nickname, profileImageUrl: $profileImageUrl, isStarter: $isStarter, status: $status, imageUrl: $imageUrl, uploadedAt: $uploadedAt, hasUnreadComments: $hasUnreadComments)';
}
...
@useResult
$Res call({
 int userId, int? shotId, String nickname, String? profileImageUrl, bool isStarter, CycleShotStatus status, String? imageUrl, DateTime? uploadedAt, bool hasUnreadComments
});
...
/// Create a copy of CycleGalleryMember
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userId = null,Object? shotId = freezed,Object? nickname = null,Object? profileImageUrl = freezed,Object? isStarter = null,Object? status = null,Object? imageUrl = freezed,Object? uploadedAt = freezed,Object? hasUnreadComments = null,}) {
  return _then(_self.copyWith(
...
as DateTime?,hasUnreadComments: null == hasUnreadComments ? _self.hasUnreadComments : hasUnreadComments // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int userId,  int? shotId,  String nickname,  String? profileImageUrl,  bool isStarter,  CycleShotStatus status,  String? imageUrl,  DateTime? uploadedAt,  bool hasUnreadComments)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CycleGalleryMember() when $default != null:
return $default(_that.userId,_that.shotId,_that.nickname,_that.profileImageUrl,_that.isStarter,_that.status,_that.imageUrl,_that.uploadedAt,_that.hasUnreadComments);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int userId,  int? shotId,  String nickname,  String? profileImageUrl,  bool isStarter,  CycleShotStatus status,  String? imageUrl,  DateTime? uploadedAt,  bool hasUnreadComments)  $default,) {final _that = this;
switch (_that) {
case _CycleGalleryMember():
return $default(_that.userId,_that.shotId,_that.nickname,_that.profileImageUrl,_that.isStarter,_that.status,_that.imageUrl,_that.uploadedAt,_that.hasUnreadComments);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int userId,  int? shotId,  String nickname,  String? profileImageUrl,  bool isStarter,  CycleShotStatus status,  String? imageUrl,  DateTime? uploadedAt,  bool hasUnreadComments)?  $default,) {final _that = this;
switch (_that) {
case _CycleGalleryMember() when $default != null:
return $default(_that.userId,_that.shotId,_that.nickname,_that.profileImageUrl,_that.isStarter,_that.status,_that.imageUrl,_that.uploadedAt,_that.hasUnreadComments);case _:
  return null;
...
class _CycleGalleryMember implements CycleGalleryMember {
  const _CycleGalleryMember({required this.userId, required this.shotId, required this.nickname, required this.profileImageUrl, required this.isStarter, required this.status, required this.imageUrl, required this.uploadedAt, required this.hasUnreadComments});
...
/// Create a copy of CycleGalleryMember
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userId = null,Object? shotId = freezed,Object? nickname = null,Object? profileImageUrl = freezed,Object? isStarter = null,Object? status = null,Object? imageUrl = freezed,Object? uploadedAt = freezed,Object? hasUnreadComments = null,}) {
